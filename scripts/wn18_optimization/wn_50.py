...
cmd_sgd = './learn_parameters.py --seed=%d --strategy=%s --totepochs=%d --lr=%f --ndim=%d  --name=wn_50/wn_%s_%d  --train=%s --nbatches=%d --use_db --no_rescaling > logs/wn_50/wn.%s.%d.log 2>&1'

# def adagrad(param, rate, epsilon, gradient, updates, param_squared_gradients):
cmd_adagrad = './learn_parameters.py --seed=%d --strategy=%s --totepochs=%d --lr=%f --ndim=%d  --name=wn_50/wn_%s_%d  --train=%s --nbatches=%d --use_db --no_rescaling > logs/wn_50/wn.%s.%d.log 2>&1'

# def adadelta(param, rate, decay, epsilon, gradient, updates, param_squared_gradients, param_squared_updates):
cmd_adadelta = './learn_parameters.py --seed=%d --strategy=%s --totepochs=%d --epsilon=%f --decay=%f --ndim=%d  --name=wn_50/wn_%s_%d  --train=%s --nbatches=%d --use_db --no_rescaling > logs/wn_50/wn.%s.%d.log 2>&1'

# def rmsprop(param, rate, decay, max_learning_rate, epsilon, gradient, updates, param_squared_gradients):
cmd_rmsprop = './learn_parameters.py --seed=%d --strategy=%s --totepochs=%d --lr=%f --decay=%f --max_lr=%f --ndim=%d  --name=wn_50/wn_%s_%d  --train=%s --nbatches=%d --use_db --no_rescaling > logs/wn_50/wn.%s.%d.log 2>&1'

# def momentum(param, rate, decay, gradient, updates, param_previous_update):
cmd_momentum = './learn_parameters.py --seed=%d --strategy=%s --totepochs=%d --lr=%f --decay=%f --ndim=%d  --name=wn_50/wn_%s_%d  --train=%s --nbatches=%d --use_db --no_rescaling > logs/wn_50/wn.%s.%d.log 2>&1'
