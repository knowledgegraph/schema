...
def main(argv):
    ...
    train_lhs_path = 'original/FB15k-train-lhs.pkl'
    train_rel_path = 'original/FB15k-train-rel.pkl'
    train_rhs_path = 'original/FB15k-train-rhs.pkl'
    ...
    train_f = open('FB15k-train.pkl', 'wb')
